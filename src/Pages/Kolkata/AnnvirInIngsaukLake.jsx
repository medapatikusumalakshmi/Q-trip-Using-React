...
export default function GrandRubouDuWagten(){
    let[api,setApi]=useState([])
    useEffect(()=>{
    let url=fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures/detail?adventure=1157691488");
